...
public class Meal {
    ...
    @Column(name = "BRE_QTY")
    private Long breQty;  // 아침식사량 (예: 1인분, 2인분)
    ...
    @Column(name = "LUN_QTY")
    private Long lunQty;  // 점심식사량 (예: 1인분, 2인분)
    ...
    @Column(name = "DIN_QTY")
    private Long dinQty;  // 저녁식사량 (예: 1인분, 2인분)

    @Column(name = "DIN_TIME", nullable = false)
    private LocalTime dinTime;  // 저녁식사시간 (예: 18:00)

    @Column(name = "MOR_SNACK_QTY")
    private Long morSnackQty;  // 오전간식량 (예: 1인분, 2인분)

    @Column(name = "MOR_SNACK_TIME", nullable = false)
    private LocalTime morSnackTime;  // 오전간식시간 (예: 10:00)

    @Column(name = "AFT_SNACK_QTY")
    private Long aftSnackQty;  // 오후간식량 (예: 1인분, 2인분)
