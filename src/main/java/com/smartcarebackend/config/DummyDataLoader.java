...
//
//            //요양사 유저 생성
//            User giverUser = new User("giver01", "giver01@test.com", passwordEncoder.encode("1234"));
...
//
//            //보호자 유저 생성
//            User guardUser = new User("guard01", "guard01@test.com", passwordEncoder.encode("1234"));
